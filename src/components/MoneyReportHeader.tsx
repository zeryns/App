...
function MoneyReportHeaderContent({reportID: reportIDProp, shouldDisplayBackButton = false, onBackButtonPress}: MoneyReportHeaderProps) {
    ...
    // Only manage selection mode while this report screen is focused. A report header that stays mounted in the
    // navigation stack (e.g. after navigating to the rules page) must not turn off the global selection mode that
    // the focused screen just enabled. See https://github.com/Expensify/App/issues/95132.
    useEffect(() => {
