...
function WorkspaceCompanyCardExpensifyCardPromotionBanner({policy, canWriteCompanyCards, onReadOnlyAction}: WorkspaceCompanyCardExpensifyCardPromotionBannerProps) {
    ...
    const rightComponent = useMemo(() => {
        return (
            <View
                style={[styles.flexRow, styles.gap2, shouldUseNarrowLayout && !isInLandscapeMode && styles.w100, shouldUseNarrowLayout && !isInLandscapeMode && styles.justifyContentCenter]}
            >
                <Button
